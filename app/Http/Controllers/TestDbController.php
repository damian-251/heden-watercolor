...
class TestDbController extends Controller
{
    ...
    public function addToCart(Request $request) { //Al añadir un producto al carrito pasamos por esta función
        ...
        $cart = Cart::where('session_id', session()->getId())->get(); //TODO: Cuando haya usuarios habría que cambiar esto
    ...
    public function cart() {
        ...
        return view('testing.cart', compact('cart', 'shippingEur', 'shippingNok'));
